        ...
        >
            ...
            <div className="flex flex-col justify-between mt-5 p-4 md:flex-row">
                <div className="flex justify-between max-w-sm">
                    <Link className="p-2" href="https://twitter.com/FrysCrypto" target="_blank">
                    ...
                    <Link className="p-2" href="https://discord.gg/cHT2QY6s"  target="_blank">
                    ...
                    <Link className="p-2" href="https://www.linkedin.com/company/fry-foundation/" target="_blank">
                    ...
                    <Link className="p-2" href="https://facebook.com/your-profile" target="_blank">
